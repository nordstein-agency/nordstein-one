...
function Home() {
    ...
    const handleLogin = async ()=>{
        ...
        const { error } = await supabaseClient/* supabase */.O.auth.signInWithOtp({
            email
        });
...
var __webpack_exports__ = __webpack_require__.X(0, [940,35,722,893], () => (__webpack_exec__(25)));
